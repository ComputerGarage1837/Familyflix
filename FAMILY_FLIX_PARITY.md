...
| Profile switch and Watch Together | Native visible-user chooser, saved-profile switching, participant selection, combined label, feed owner, playback reporting and exit flow coded | Test login/profile switching and party reporting; port Android presets and combined group Deck; verify group feed and exit |
| Family Night and household voting | Not yet ported to native UI | Port Android picker and voting behavior |
| Backdrops, themes and detail actions | Native details, backdrop, show/season/episode navigation and 15 per-user Android palette choices coded | Port remaining Android detail actions and remote focus rules; verify every theme contrast |
