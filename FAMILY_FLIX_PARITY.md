...
| Settings sync and updates | Native session/theme/other local preferences persist through installs; Watch Together presets sync through Jellyfin | Implement Windows release check/download prompt and complete Android-like settings screens; verify persistence through an installer update |
