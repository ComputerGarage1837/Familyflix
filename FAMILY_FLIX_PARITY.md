...
| Profile switch and Watch Together | Native visible-user chooser, saved-profile switching, participant selection, combined label, feed owner and exit flow coded | Test login/profile switching; port Android presets and participant playback reporting; verify group feed and exit |
